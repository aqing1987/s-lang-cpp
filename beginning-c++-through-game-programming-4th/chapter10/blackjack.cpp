...
void Hand::Clear() {
  // iterate throuh vector, freeing all memory on the heap
...
class GenericPlayer: public Hand {
 ...
 public:
  ...
  // retruns whether generic player has busted - has a total greater than 21
  bool IsBusted() const;
...
void Deck::AdditionalCards(GenericPlayer &aGenericPlayer) {
  cout << endl;
  // continue to deal a card as long as generic player isn't
  // busted and wants another hit
