...
// pInventory can be a constant pointer because the address it stores
// doesn't change inventory can be accepted as a constant object
// because the function won't change it
